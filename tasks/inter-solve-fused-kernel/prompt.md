# Implementation prompt: inter-solve-fused-kernel
...
- Task name: `inter-solve-fused-kernel`
- Objective: Optimize chunk_kda_fwd_kernel_inter_solve_fused on GB300 Kimi K3 prefill while preserving fusion flags, safe-gate semantics, output intermediates and chunk_kda ABI.
